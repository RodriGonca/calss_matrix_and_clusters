...
Para responder as próximas questões vou utilizar uma funcão customizada a partie do pacote marcokchain e ggplot para recuperar o historico de transição entre os estados em cada período e desenhar algumas visualizações destes dados.
