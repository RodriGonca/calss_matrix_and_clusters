...
m0 <- matrix(0, nrow = 1000, ncol = 1000)                 # formato nativo do R
m1 <- Matrix(0, nrow = 1000, ncol = 1000, sparse = FALSE) # usando o pacote Matrix
m2 <- Matrix(0, nrow = 1000, ncol = 1000, sparse = TRUE)  # usando o pacote Matrix com sparce = TRUE
